...
window.onload = function(){
	...
	var newImgs = [].slice.call(allImgs); //call(allImgs) makes call function think it's being called from allImgs instead of the array.
	console.log(newImgs);
	newImgs.map(function(arrayCell){
		console.log(arrayCell);
		arrayCell.addEventListener("mouseover", flipOver);
	}
	);
}; 
